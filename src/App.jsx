            ...
            <div className="bg-slate-900 rounded-xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300 border border-cyan-500/20 shadow-xl">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  <a href="#" className="flex-1 text-center px-4 py-2 bg-gradient-to-r from-cyan-500 to-purple-500 text-white rounded-lg hover:from-cyan-600 hover:to-purple-600 transition-all">
                    Live Demo
                  </a>
                  <a href="#" className="flex-1 text-center px-4 py-2 border border-cyan-400 text-cyan-400 rounded-lg hover:bg-cyan-400 hover:text-slate-900 transition-all">
                    GitHub
                  </a>
                </div>
              </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-xl border border-purple-500/20">
            ...
            <div className="mb-8 space-y-4">
              ...
              <div className="flex items-center justify-center gap-3 text-gray-300">
                ...
                <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="hover:text-purple-400 transition-colors">
                  GitHub Profile
                </a>
              </div>
